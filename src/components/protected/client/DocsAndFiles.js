...
class DocsAndFiles extends ClientRoleAwareComponent {
  ...
  chooseFile = e => {
    ...
    file.createdAt = this.setState({ file });
  };
  ...
  uploadFile = () => {
    ...
    firebaseStorage()
      ...
      .child('documents')
      .child(file.key)
      .child(file.originName)
      .put(file.value, metadata)
      .then(snap => {
    ...
    const jsx = (
      <div>
          ...
          <div className="col-8">
            <div className="text-right">
              <div>
                {this.isAdmin() && (
                  <RaisedButton
                    className="btn-smotion primary btn-large"
                    label="Upload New"
                    onClick={() => {
                      this.setState({ docsDialogVisible: true });
                    }}
                  />
                )}
              </div>
        ...
        <div className="smotion-table selection docs-table">
          ...
          >
            <TableHeaderColumn width="30" dataField="name" dataFormat={this.docFormatter} />
            ...
            <TableHeaderColumn
              ...
              formatExtraData={this.state.docsType}
              dataSort
            >
              Type
            </TableHeaderColumn>
            <TableHeaderColumn
              ...
              dataFormat={this.descriptionFormatter}
              formatExtraData={this.state.docsCategory}
              dataSort
            >
              Category
            </TableHeaderColumn>
            <TableHeaderColumn width="120" dataField="language" dataFormat={this.languageFormatter} dataSort>
              Language
            </TableHeaderColumn>
            <TableHeaderColumn width="120" dataField="createdAt" dataSort>
              Modified
            </TableHeaderColumn>
            <TableHeaderColumn width="80" dataField="size" dataFormat={this.sizeFormatter} dataSort>
              Size
            </TableHeaderColumn>
            <TableHeaderColumn width="50" dataFormat={this.downloadFormatter} />
          </BootstrapTable>
        </div>
            ...
            <div className="col-12">
              <div className="bg-gray">
                <div className="row header">
                  ...
                  <div className="col-2">
                    <a className="close" onClick={this.handleCloseDialog}>
                      X
                    </a>
                  </div>
                </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-6">
                            <SelectValidator
                              ...
                              errorMessages={['This field is required']}
                            >
                              {this.state.docsType.map(
                                (docType, i) => <MenuItem key={i} value={i} primaryText={docType.description} />,
                                this
                              )}
                            </SelectValidator>
                          </div>
                          ...
                          <div className="col-6">
                            ...
                            <div>
                              <div className="row form-switches-inline">
                                {this.state.docsLanguage.map(
                                  (docLanguage, i) => (
                                    <div key={i} className="col-3">
                                      <Checkbox
                                        onCheck={(o, checked) => this.handleToggleLanguage(docLanguage.short, checked)}
                                        valueLink={this.state.file.languages}
                                        label={docLanguage.short}
                                      />
                                    </div>
                                  ),
                                  this
