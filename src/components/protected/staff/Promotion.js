...
class Promotion extends CommonRoleAwareComponent {
  ...
  getImageLevel = index => {
    ...
    image =
      this.state.promotion.levels[index].previewImage !== undefined
  ...
  uploadCampaignPackage = () => {
    ...
    firebaseStorage()
      ...
      .child('promotions')
      .child(promotion.key)
      .child('campaignPackage')
      .put(promotion.campaignPackage)
      .then(snap => {
            ...
            <div className="col-4">
              <div className="panel-header-image">
                {this.state.promotion.logoPreviewImage === undefined ? (
                  ...
                  <FlatButton labelPosition="after" className="btn-smotion link" containerElement="label">
                    <Paper
            ...
            <div className="row">
              <div className="col-8">
                <span className="promotion-name">
                  <input
                    ...
                    type="text"
                    placeholder="Edit Campaing Name"
                    name="name"
              ...
              <div className="col-4">
                <div className="promotion-download-package">
                  <FlatButton labelPosition="after" containerElement="label">
                    <Chip style={{ margin: 4 }}>Upload Campaign Package</Chip>
            ...
            <div className="promotion-detail description" style={{ display: this.state.showDetail }}>
              <div className="col-12">
                <textarea
                  onChange={this.handleChangeInput}
                  name="description"
                  className="transparent-input fullwidth"
          ...
          <div className="row">
            <div className="col-12">
              <div className="bg-gray">
                <div className="row header">
                  ...
                  <div className="col-1">
                    <a
                      className="close"
                      onClick={() => {
                        this.setState({ openLevelDialog: false });
                      }}
                    >
                      x
                    </a>
                ...
                <div className="row">
                  <div className="col-10 offset-1">
                    <ValidatorForm ref="form" onSubmit={this.handleApplyLevelInfo}>
                      <div className="white-form">
                        <div className="row">
                          <div className="col-9">
                            <TextValidator
                              floatingLabelFixed
                              floatingLabelText="Active Level Image"
                              fullWidth
                              name="activeImgName"
                              disabled={true}
                          ...
                          <div className="col-9">
                            <TextValidator
                              floatingLabelFixed
                              floatingLabelText="Inactive Level Image"
                              fullWidth
                        ...
                        <div className="row">
                          <div className="col-4">
                            <TextValidator
                              floatingLabelFixed
                              floatingLabelText="Bets To Reach"
                              fullWidth
                              name="bestToReach"
