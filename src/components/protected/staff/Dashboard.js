...
class Dashboard extends StaffRoleAwareComponent {
  ...
  signupsDBCallback = (snap, concat) => {
    ...
    if (signup.status === constants.promotionsStatus.pending || signup.status === constants.promotionsStatus.declined) {
      if (concat) {
      ...
      <div className="text-left">
        <span>
          <RaisedButton
            ...
            label={row.status === constants.promotionsStatus.forfeited ? 'Forfeited' : 'Forfeit'}
            secondary
          />
        </span>
      </div>
              ...
              <div className="smotion-table signups-table">
                <BootstrapTable data={this.state.usersSignUp} options={{ hideSizePerPage: true }} bordered={false}>
                  ...
                  <TableHeaderColumn
                    ...
                    width="80"
                    dataField="promotion"
                    dataFormat={(c, r) => this.promotionFormatter(c, r, 'name')}
                  >
                    Game
                  </TableHeaderColumn>
                  <TableHeaderColumn
                  ...
                  <TableHeaderColumn dataAlign="center" width="80" dataField="createdAt">
                    Requested
                  </TableHeaderColumn>
                  <TableHeaderColumn dataAlign="center" width="180" dataFormat={this.signUpActionsFormatter} />
                </BootstrapTable>
              </div>
            </div>
          </div>
            ...
            <div className="campaigns text-left">
              ...
              <div className="col-11">
                <div className="smotion-table campaigns-table">
                  <BootstrapTable
                    data={this.state.activeUsersSignUp}
                    options={{ hideSizePerPage: true }}
                    bordered={false}
                  >
                    <TableHeaderColumn width="80" dataField="user" isKey dataFormat={this.userFormatter}>
                      Client
                    </TableHeaderColumn>
                    <TableHeaderColumn
                      width="60"
                    ...
                    <TableHeaderColumn width="80" dataField="createdAt">
                      Signed Up
                    </TableHeaderColumn>
                    <TableHeaderColumn
                      width="80"
                      dataField="promotion"
                      dataFormat={(c, r) => this.promotionFormatter(c, r, 'endDate')}
                    >
                      Ends
                    </TableHeaderColumn>
